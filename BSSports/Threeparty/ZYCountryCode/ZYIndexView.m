...
@interface ZYIndexView()

@property (nonatomic, strong) UILabel *preLabel;
@property (nonatomic, assign) NSInteger preIndex;
@property (nonatomic, strong) NSMutableArray *labelArr;
@property (nonatomic, strong) ZYCustomView *indexDetailView;

@end



@implementation ZYIndexView
...
- (void)setIndexes:(NSArray *)indexes {
    ...
    _indexDetailView = [[ZYCustomView alloc] initWithFrame:CGRectMake(-80, 0, 50, 50)];
...
- (void)toSelectTitle:(CGPoint)touchPoint {
    ...
    if (_delegate && [_delegate conformsToProtocol:@protocol(ZYIndexDelegate)]) {
