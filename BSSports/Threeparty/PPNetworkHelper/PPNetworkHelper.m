...
+ (NSURLSessionTask *)uploadFileWithURL:(NSString *)URL
    ...
    sessionManager.requestSerializer.timeoutInterval = 40;
    
    NSURLSessionTask *sessionTask = [sessionManager POST:URL parameters:parameters headers:nil constructingBodyWithBlock:^(id<AFMultipartFormData>  _Nonnull formData) {
