...
/** 缩放因子X */
static inline CGFloat kScreenScaleX(CGFloat x){
    return x*[DWScreenKit scaleX];
}

/** 底部栏高度 */
static inline CGFloat kHXDTabBarHeight(){
...
/** 状态栏高度kScreenScaleX inline CGFloat kStatusBarHeight(){
...
/** 适配字体 */
static inline UIFont * kScaleFontSizefontName(NSString * fontName,CGFloat fontSize){
    return [DWScreenKit scaleFontWithName:fontName fontSize:fontSize];
}
