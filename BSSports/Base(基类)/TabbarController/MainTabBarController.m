...
//    PersonListViewController *homeVC = [[PersonListViewController alloc]init];
    [self setupChildViewController:homeVC title:@"首页" imageName:@"icon_tab_home" seleceImageName:@"icon_tab_home_in_video"];
...
//    MakeFriendsViewController *makeFriendVC = [[MakeFriendsViewController alloc]init];
    ...
    [self setupChildViewController:makeFriendVC title:@"我的" imageName:@"icon_tab_mine_in_video" seleceImageName:@"icon_tab_mine_selected"];
